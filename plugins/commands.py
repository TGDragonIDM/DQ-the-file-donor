...
from info import CHANNELS, ADMINS, AUTH_CHANNEL, LOG_CHANNEL, PICS, BATCH_FILE_CAPTION, CUSTOM_FILE_CAPTION, PROTECT_CONTENT, MAX_B_TN, VERIFY
...
async def start(client, message):
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        await client.send_message(
            ...
            text="**Hello 👋 \n\nYou Have Not Subscribed To My Updates Channel So You Do Not Get The Files On Inline Mode, Bot PM And Group.\n\n🔔 SUBSCRIBE 🔔 My Updates Channel And 🔄 Try Again.**",
    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        if is_valid == True:
            await message.reply_text(
                text=f"<b>Hey {message.from_user.mention}, You Are Successfully Verified..!\nNow You Have Unlimited Access For All Movies/Series Till Today Midnight.</b>",
                protect_content=True
            )
    ...
    if not files_:
        ...
        try:
            ...
            if CUSTOM_FILE_CAPTION:
                try:
                    f_caption=CUSTOM_FILE_CAPTION.format(message.from_user.mention, file_name= '' if title is None else title, file_size='' if size is None else size, file_caption='')
                except:
                    return
...
async def delete_all_index_confirm(bot, message):
    ...
    await message.answer('Connecting Film Lovers')
    ...
    if settings is not None:
        buttons = [
            ...
            [
                ...
                InlineKeyboardButton(
                    '☑️ On' if settings["botpm"] else '❎ Off',
                    callback_data=f'setgs#botpm#{settings["botpm"]}#{grp_id}',
                ),
            ],
            [
                ...
                InlineKeyboardButton(
                    '☑️ On' if settings["file_secure"] else '❎ Off',
                    callback_data=f'setgs#file_secure#{settings["file_secure"]}#{grp_id}',
                ),
            ],
            [
                ...
                InlineKeyboardButton(
                    '☑️ On' if settings["imdb"] else '❎ Off',
                    callback_data=f'setgs#imdb#{settings["imdb"]}#{grp_id}',
                ),
            ],
            [
                ...
                InlineKeyboardButton(
                    '☑️ On' if settings["spell_check"] else '❎ Off',
                    callback_data=f'setgs#spell_check#{settings["spell_check"]}#{grp_id}',
                ),
            ],
            [
                ...
                InlineKeyboardButton(
                    '☑️ On' if settings["welcome"] else '❎ Off',
                    callback_data=f'setgs#welcome#{settings["welcome"]}#{grp_id}',
                ),
            ],
            [
                ...
                InlineKeyboardButton(
                    '10 Minutes' if settings["auto_delete"] else '❎ Off',
                    callback_data=f'setgs#auto_delete#{settings["auto_delete"]}#{grp_id}',
                ),
            ],
            [
                ...
                InlineKeyboardButton(
                    '☑️ On' if settings["auto_ffilter"] else '❎ Off',
                    callback_data=f'setgs#auto_ffilter#{settings["auto_ffilter"]}#{grp_id}',
                ),
            ],
            [
            ...
            [
                ...
                InlineKeyboardButton(
                    '☑️ On' if settings["is_shortlink"] else '❎ Off',
                    callback_data=f'setgs#is_shortlink#{settings["is_shortlink"]}#{grp_id}',
                ),
            ],
        ]
        ...
        if chat_type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
            await message.reply_text(
                text="<b>Where Do You Want To Open The Settings Menu..?</b>",
                reply_markup=InlineKeyboardMarkup(btn),
